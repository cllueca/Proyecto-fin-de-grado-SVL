<template>
  <div v-if="this.$store.state.serviciosDisponibles != null" v-for="servicio in this.$store.state.serviciosDisponibles">
    ...
    <div class="container infoServicio hidden" :id="'info' + servicio.id">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12" style="width: 96%; margin-left: 2%; margin-top:10px;">
  ...
  <div v-else>
    Todos los servicios disponibles estan enlazados
  </div>
</template>
